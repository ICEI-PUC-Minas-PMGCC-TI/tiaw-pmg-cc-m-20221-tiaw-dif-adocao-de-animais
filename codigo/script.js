...
const dadosIniciais = {
    usuarios: [
        { "id": generateUUID(), "login": "admin", "senha": "123", "nome": "Adm do Sistema", "email": "rtw@123.com" },
...
function addUser(nome, login, senha, email) {
    ...
    for (let i = 0; i < db_usuarios.usuarios.length; i++) {
        const usuario = db_usuarios.usuarios[i];
    ...
    const usuario = { "id": newId, "login": login, "senha": senha, "nome": nome, "email": email };
